...
calisamaKitabi = xlsxwriter.Workbook('Türkiye Covid 19 Radar Grafiği.xlsx')
...
chartYapim = calisamaKitabi.add_chart({'type' : 'radar', 'subtype' : 'with_markers', 'subtype' : 'filled'})
...
chartYapim.set_x_axis({'name' : 'Günler'})
chartYapim.set_y_axis({'name': 'Sayılar'})
